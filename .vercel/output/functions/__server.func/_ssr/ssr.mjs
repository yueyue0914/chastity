...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CrQrQK-U.mjs");
...
var manifest = {
	"1d6e829f751f9cef738608588620249a94fd1408da0cb42fc2e257b66aa163f9": {
		functionName: "unlockLock_createServerFn_handler",
		importer: () => import("./lock-server-C_GjQgvi.mjs")
	},
	"6acf5e69baa4554d4739810037439276292b15a4f582f189b9ef038cd85917b9": {
		functionName: "createLockSession_createServerFn_handler",
		importer: () => import("./lock-server-C_GjQgvi.mjs")
	},
	"9355962f03a88467c0da0eeb61ba24a5575010aa0c6ac0a6db3733d8ce9661a7": {
		functionName: "getLockByKeyholder_createServerFn_handler",
		importer: () => import("./lock-server-C_GjQgvi.mjs")
	},
	"ce61c7057be7e235a30ac96aecd309dfa93b7a7881633f0beba634411994b009": {
		functionName: "endHygiene_createServerFn_handler",
		importer: () => import("./lock-server-C_GjQgvi.mjs")
	},
	"d455b087b01b39567d2e9644d2cc15051f9f2a646fb8764a5ef90f7c26871fe6": {
		functionName: "startHygiene_createServerFn_handler",
		importer: () => import("./lock-server-C_GjQgvi.mjs")
	},
	"d83011a9539f70567155d14a76736e50e3056f2853f37cc156a9e9ce041f8ad7": {
		functionName: "getLockByWearer_createServerFn_handler",
		importer: () => import("./lock-server-C_GjQgvi.mjs")
	},
	"ef38349cb74bafaa215ed9e73874a0feb82f24d2f028d6a7f3c54381bb1766c6": {
		functionName: "keyholderAddTime_createServerFn_handler",
		importer: () => import("./lock-server-C_GjQgvi.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C2-c-c6O.mjs").then((n) => n.t),
